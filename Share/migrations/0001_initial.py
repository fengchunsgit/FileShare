    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DownloadDoccount', models.IntegerField(verbose_name='访问次数', default=0)),
                ('code', models.CharField(verbose_name='code', max_length=8)),
                ('Datatime', models.DateField(verbose_name='添加时间', default=datetime.datetime(2017, 12, 26, 18, 51, 41, 427203))),
